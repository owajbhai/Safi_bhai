...
BOT_TOKEN = environ.get('BOT_TOKEN', "8063639700:AAHBKag6QmeJT7FWSp1s-CVBq-vkVw8D-y8")
...
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/Cpm54sPN/c245ba499aa8.jpg') # Scanner Code image 
...
premium = environ.get('PREMIUM_LOGS', '-1001860172104')
...
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "botmaster55") # widout 👉 @
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002310160204').split()]
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002548721158'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002548721158'))
NO_RESULTS_MSG = is_enabled((environ.get("NO_RESULTS_MSG", 'True')), False)

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster00")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Safaribotts0')
